...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/grade.js"></script>
...
<div class="main-container ace-save-state" id="main-container">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                            <button id="AddGrade" type="button" class="btn btn-info" style="float:left">新增班级</button>
                               <table id="student-table" class="table  table-bordered table-hover">
											...
											<c:forEach items="${gradeList}" var="List">
												<tr>
													...
													<td class="hidden-480">${List.personnum }</td>
													<td>${List.avgscore }</td>
													...
													<td>
														...
														<div class="hidden-sm hidden-xs btn-group">
															<button class="btn btn-xs btn-info" onclick="upd(${List.id},'${List.gradename }')">
	...
	<div class="modal fade" id="addGradeModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
            	<button id="GradeSubmit" type="button" class="btn btn-info" data-dismiss="modal" style="float:left">提交
                </button>
	...
	<div class="modal fade" id="updateGradeModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
            ...
            <div class="modal-footer">
            	<button id="updateGradeSubmit" type="button" class="btn btn-info" data-dismiss="modal" style="float:left">提交
                </button>
                <button id="close" type="button" class="btn btn-default" data-dismiss="modal" >关闭
                </button>
