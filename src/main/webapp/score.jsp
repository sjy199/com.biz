...
<div class="main-container ace-save-state" id="main-container">
    ...
    <div id="sidebar" class="sidebar responsive ace-save-state">
        ...
        <%-- <ul class="nav nav-list">
            <li class="">
                ...
                <ul class="submenu">
                    <li class="">
                        <a href="${pageContext.request.contextPath}/subject/findAllSub.do">
            ...
            <li class="active open">
                ...
                <ul class="submenu">
                  ...
                  <ul class="submenu">
                    class="active"控制三角标
                    <li class="">
                        <a href="${pageContext.request.contextPath}/findAllScore.do">
                            <i class="menu-icon fa fa-caret-right"></i>
                            学生分数管理
                        </a>
                        <b class="arrow"></b>
            ...
            <li class="">
                ...
                <ul class="submenu">
                    <li class="">
                        <a href="${pageContext.request.contextPath}/findAll.do">
                            <i class="menu-icon fa fa-caret-right"></i>
                            班级信息
                        </a>
                        <b class="arrow"></b>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                               <table id="score-table" class="table  table-bordered table-hover">
											<thead>
												<tr>
													<th class="center">
														<label class="pos-rel">
											...
											<c:forEach items="${scoreList}" var="List">
												<tr>
													...
													<td>${List.student.studentid }</td>
													<td>${List.student.name }</td>
													<td class="hidden-480">${List.subject.name }</td>
													<td>${List.score }</td>
													...
													<td>
														...
														<div class="hidden-sm hidden-xs btn-group">
															<button class="btn btn-xs btn-info" onclick="upd('${List.id }','${List.score}')">
	...
	<div class="modal fade" id="updateScoreModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
            	<button id="updateScoreSubmit" type="button" class="btn btn-info" data-dismiss="modal" style="float:left">提交
                </button>
